<?php
/**
 * This object will assist in updating from the wp-gdrive-to-posts Github
 * repo. This object was inspired from and mostly taken from the article
 * on Code TutsPlus:
...
class GDrive_to_Posts_Updater {
    ...
    private function getRepoReleaseInfo() {
        ...
        // We need the access token for private repos (of which gdrive-to-posts is not).
